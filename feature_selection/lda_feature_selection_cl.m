...
fprintf('  Model            : LDA (Linear Discriminant Analysis)\n');
...
%% ========================================================
%% STEP 3: LDA FEATURE SELECTION  (Leave-One-Trial-Out CV)
%% ========================================================

fprintf('=======================================================\n');
fprintf('STEP 3: LDA FEATURE SELECTION\n');
    ...
    for k = 1:length(remaining_features)
        ...
        for fold = 1:num_folds
            ...
            try
                ...
                % Skip fold if LDA fails (e.g. rank-deficient covariance)
            end
        end
...
fprintf('\n[%s] LDA feature selection complete!\n', datetime('now','Format','HH:mm:ss'));
...
txt_filename = fullfile(output_folder, 'LDA_selected_features.txt');
fid = fopen(txt_filename, 'w');

fprintf(fid, '=======================================================\n');
fprintf(fid, 'LDA SELECTED FEATURES (Phase: %s)\n', ground_to_test);
fprintf(fid, '=======================================================\n\n');
...
mat_filename = fullfile(output_folder, 'LDA_selected_features.mat');
...
fprintf('\nOutput saved to: %s\n', output_folder);
fprintf('\n=======================================================\n');
fprintf('LDA FEATURE SELECTION COMPLETE!\n');
fprintf('=======================================================\n');